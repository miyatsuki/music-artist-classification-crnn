...
def train_model(
    ...
    #     save_weights_folder,
    #    str(nb_classes) + "_" + str(slice_length) + "_" + str(random_states),
    # )
    weights = os.path.join(
        save_weights_folder,
        str(nb_classes)
    ...
    filename = os.path.join(
        save_metrics_folder,
        str(nb_classes) + "_" + str(slice_length) + "_" + str(random_states) + ".txt",
    )
    ...
    scores_dict = classification_report(
        y_true, y_predict, target_names=class_names_original, output_dict=True
    )
    print(scores)

    # Predict artist using pooling methodology
    pooling_scores, pooled_scores_dict = utility.predict_artist(
        model,
        X_test,
        Y_test,
        S_test,
